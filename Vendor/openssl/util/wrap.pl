...
BEGIN {
    ...
    require '/Volumes/Store/Work/Projects/PassTool/Vendor/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Volumes/Store/Work/Projects/PassTool/Vendor/openssl/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/Volumes/Store/Work/Projects/PassTool/Vendor/openssl/test/default-and-jitter.cnf';
    shift;

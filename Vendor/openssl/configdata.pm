...
our %config = (
    ...
    "openssldir" => "",
    "options" => "--prefix=/Volumes/Store/Work/Projects/PassTool/.vendor/openssl no-acvp-tests no-allocfail-tests no-asan no-brotli no-brotli-dynamic no-buildtest-c++ no-crypto-mdebug no-demos no-dso no-dynamic-engine no-ec_explicit_curves no-ec_nistp_64_gcc_128 no-egd no-engine no-external-tests no-fips no-fips-jitter no-fips-post no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-h3demo no-hqinterop no-jitter no-ktls no-lms no-md2 no-module no-msan no-pie no-rc5 no-sctp no-shared no-sslkeylog no-static-engine no-static-vcruntime no-tests no-tfo no-tls-deprecated-ec no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-winstore no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "0",
    ...
    "perlargv" => [
        ...
        "no-dso",
        "no-tests",
        "--prefix=/Volumes/Store/Work/Projects/PassTool/.vendor/openssl"
    ],
    "perlenv" => {
        "AR" => undef,
        "ARFLAGS" => undef,
...
our %unified_info = (
    ...
    "depends" => {
        ...
        "doc/html/man3/X509_check_certificate_times.html" => [
        ...
        "doc/man/man3/X509_check_certificate_times.3" => [
            "doc/man3/X509_check_certificate_times.pod"
        ],
    ...
    "dirinfo" => {
        ...
        "crypto/aes" => {
            "deps" => [
                "crypto/aes/libcrypto-lib-aes-sha1-armv8.o",
                "crypto/aes/libcrypto-lib-aes-sha256-armv8.o",
                "crypto/aes/libcrypto-lib-aes-sha512-armv8.o",
        ...
        "crypto/evp" => {
            "deps" => [
                ...
                "crypto/evp/libcrypto-lib-enc_b64_avx2.o",
                "crypto/evp/libcrypto-lib-enc_b64_scalar.o",
        ...
        "crypto/poly1305" => {
            "deps" => [
                ...
                "crypto/poly1305/libcrypto-lib-poly1305-armv9-sve2.o",
...
my %disabled_info = (
    ...
    "ec_explicit_curves" => {
        "macro" => "OPENSSL_NO_EC_EXPLICIT_CURVES"
    },
    "ec_nistp_64_gcc_128" => {
...
unless (caller) {
    ...
    use lib '/Volumes/Store/Work/Projects/PassTool/Vendor/openssl/util/perl';
    use OpenSSL::fallback '/Volumes/Store/Work/Projects/PassTool/Vendor/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Volumes/Store/Work/Projects/PassTool/Vendor/openssl/Configurations';
        use gentemplate;
